...
Live demo here: <a href="https://portfolio-adityanegi.vercel.app/" target="_blank">Aditya Negi Portfolio</a>
<br/>
Readme here: <a href="https://github.com/Cyrus748/TASK-1-CodeClause" target="_blank">Cyrus748/TASK-1-CodeClause/</a>
    ...
    const SEO = [
    	{
    		page: "home",
    		description:
    			"I am a fullstack web developer with expertise in Frontend. I have experience in building scalable, secure and reliable web applications using various frameworks and technologies.",
    		keywords: ["Aditya", "Aditya N", "Aditya Negi"],
    	},
    ];
    ```
